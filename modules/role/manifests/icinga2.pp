...
#
class role::icinga2 (
    String $icinga2_db_host                 = lookup('icinga_ido_db_host', {'default_value' => 'db1.wikitide.net'}),
    ...
    String $icingaweb2_ido_db_host          = lookup('icinga_ido_db_host', {'default_value' => 'db1.wikitide.net'}),
