...
openssl req -new -x509 -sha256 -key $1/wikitide-ca-key.pem -subj "/C=US/ST=DC/L=Washington/O=WikiTide Corp." -out $1/wikitide-ca.pem -days 730
...
openssl req -new -key $1/admin-key.pem -subj "/C=US/ST=DC/L=Washington/O=WikiTide Corp./CN=ADMIN_WIKITIDE" -out $1/admin.csr
