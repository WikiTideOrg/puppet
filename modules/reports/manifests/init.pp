...
class reports {
    ...
    git::clone { 'reports':
        ...
        origin    => 'https://github.com/WikiTideOrg/Reports',
        branch    => 'v12',
        owner     => 'www-data',
        group     => 'www-data',
    }
    ...
    exec { 'reports_composer':
        ...
        creates     => '/srv/reports/vendor',
        cwd         => '/srv/reports',
        path        => '/usr/bin',
        environment => 'HOME=/srv/reports',
        user        => 'www-data',
        require     => Git::Clone['reports'],
    }

    git::clone { 'errorpages':
        ensure    => latest,
        directory => '/srv/reports/public/ErrorPages',
    ...
    nginx::site { 'reports.wikitide.net':
        ensure  => present,
    ...
    cron { 'Task Scheduler':
        ...
        command => '/usr/bin/php /srv/reports/artisan schedule:run >> /dev/null 2>&1',
        user => 'www-data',
        minute => '*'
    }
}